  ...
  build: {
    rollupOptions: {
      input: {
        ...
        App_sep: resolve(__dirname, 'apps/differential-equations-apps/App-sep/index.html'),
        App_linear: resolve(__dirname, 'apps/differential-equations-apps/App-linear/index.html'),
        App_logistic: resolve(
          __dirname,
          'apps/differential-equations-apps/App-logistic/index.html'
        ),
        App_resonance: resolve(
          __dirname,
          'apps/differential-equations-apps/App-resonance/index.html'
        ),
        App_sec_order: resolve(
          __dirname,
          'apps/differential-equations-apps/App-sec-order/index.html'
        ),
        App_vs: resolve(__dirname, 'apps/vibrating-string-app/index.html'),
        ...
        freeDrawReflection: resolve(__dirname, 'apps/symmetry/freeDrawReflection/index.html'),
        FreeDrawRotation: resolve(__dirname, 'apps/symmetry/freeDrawRotation/index.html'),
        FreeDrawTranslation: resolve(__dirname, 'apps/symmmetry/freeDrawTranslation/index.html'),
        GraphDraw: resolve(__dirname, 'apps/symmmetry/graphDraw/index.html'),
        GraphDrawReflection: resolve(__dirname, 'apps/symmmetry/graphDrawReflection/index.html'),
        GraphDrawRotation: resolve(__dirname, 'apps/symmmetry/graphDrawRotation/index.html'),
        GraphDrawTranslation: resolve(__dirname, 'apps/symmmetry/graphDrawTranslation/index.html'),
