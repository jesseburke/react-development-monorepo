...
const minMaxAtom = atom((get) => {
  const { yMin, yMax } = get(boundsData.atom);

  return { min: yMin, max: yMax };
});

export const animationData = AnimationData({ minMaxAtom });
...
export const planeCenterAtom = atom((get) => {
  ...
  // console.log('planeCenterAtom get call; xMin = ', xMin, 'xMax = ', xMax, 't = ', t);
