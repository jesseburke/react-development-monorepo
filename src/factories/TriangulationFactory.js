...
export default function TriangulationFactory( pointArray ) {
    ...
    if( pointArray.length < 2 ) {
        ...
        console.log( 'TriangulationFactory called with argument pointArray having less than 2 elements; returned null');
	...
	if( !centerArray )
	    centerArray = forEachTriangle( (t) => circumcenter(t) );
   ...
   // does a lot more errorr checking
    ...
    return {getPoints, getD, pointsOfTriangle,
	    forEachTriangle, getCenterArray, getRadiusArray,
	    triangleOfLineSeg, trianglesOfCurve, halfedgesOfPoint,
	    radiusAndCenter,
	    getRadiusAndCenterArray, pointsOfTriangle};
