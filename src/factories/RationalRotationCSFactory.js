...
import RationalRotationFactory from './RationalRotationFactory.js';
...
export default function RationalRotationCSFactory( m, n ) {
	...
	console.log( 'RationalRotationFactory was called with a non-integer argument; returned null' );
	return;
    }

    if( m < 0 || n <= 0 ) {

	console.log( 'RationalRotationFactory was called with a non-positive integer argument; returned null' );
	return;
    }
