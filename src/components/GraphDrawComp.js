...
function GraphDrawComp({ threeCBs,
                         doneCBs = ([() => null]),
                         transforms = [], material,
                         clearCB,
                         fontSize = '1em' }) {
    ...
    return (
        ...
        <div css={{
          ...
          <div
            ...
            onClick={undoCB}
           >            
            <span css={{padding: '.15em',
                        fontSize: '2rem',
                        userSelect: 'none'}}>{'\u{270F}'}</span>
        </div>
        </div>     
    );    
}
...
function GraphDrawFactory({ threeCBs,
                            transforms = [],
                            material = new THREE.MeshBasicMaterial({ color: 0xff0000 }),
                            tubeGeometryOptions = {tubularSegments: 128,
                                                   radius: .05,
                                                   radialSegments: 4,
                                                   closed: false},
                            sphereGeometryOptions = {radius: .25,
                                                     widthSegments: 32,
                                                     heightSegments: 32} }) {  
    ...
    function mouseDownCB( e ) {
        ...
        let newPt = processCoords( getMouseCoords(e, planeMesh) );
        ...
        let sphereGeom = new THREE.SphereBufferGeometry( sphereRadius,
                                                           widthSegments,
                                                         heightSegments );
