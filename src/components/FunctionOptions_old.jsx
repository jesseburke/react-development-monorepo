...
function FunctionOptions({ data: { func, xMin, xMax, yMin, yMax, meshSize, color }, onChange }) {
    return (
        <div
            css={{
                padding: '1em',
            ...
            <div
                ...
                <Color
                    colorStr={color}
                    onChange={(colorStr) =>
                        onChange({ func, xMin, xMax, yMin, yMax, meshSize, color: colorStr })
                    }
                />
                <MeshSize
                    size={meshSize}
                    onChange={(size) =>
                        onChange({ func, xMin, xMax, yMin, yMax, meshSize: size, color })
                    }
                />
            </div>
        </div>
