...
export default function ArrowGeometry({ length }) {
    ...
    const rawGeom = RawArrowGeometry({baseLength: 1.25, baseRadius: .1,
				      tipLength: .75, tipRadius: .35});	
...
function RawArrowGeometry({baseLength, baseRadius, tipLength, tipRadius}) {    
    ...
    const base = new THREE.CylinderBufferGeometry(radiusTop, radiusBottom,
    ...
    const tip = new THREE.ConeBufferGeometry(radius, height, radialSegments,
