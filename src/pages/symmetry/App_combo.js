...
export default function App() {    
    ...
    useEffect( () => {
        ...
        const geom = OriginLine({vec: linePt,
                                 radius: reflectionLineRadius});       
    ...
    const resetCB = useCallback( () => {
      ...
      const drawWithLineCB = useCallback( () => {
        ...
        if( fixedMesh.getMesh() ) {
            ...
            // rotate mesh back to original position
            gsapRotate({ mesh: fixedMesh.getMesh(),
		         delay: 0,
                         duration: rotationDuration,
    ...
    return (
    	...
    	<FullScreenBaseComponent fonts={fonts} backgroundColor={ '#0A2C3C'}>
          ...
          <ControlBar height={controlBarHeightPerc} fontSize={'1em'}>
           ...
           <Main height={100-controlBarHeightPerc}
                 fontSize={'1em'}>
                 ...
                 <div css={{
                   ...
                   <div css={{
                     ...
                     <div  css={{ cursor:'pointer' }}>                 
                       <Button onClickFunc={drawWithLineCB}>
                         Draw with line
                       </Button>          
                     </div>
                     <div  css={{ cursor:'pointer' }}>                 
