...
export default function gsapRotate({ mesh,
                                     angle,
				     quaternion,
	...
	console.log('gsapRotate needs angle or quaternion argument; if both are given, angle takes precedence and quaternion is ignored');
